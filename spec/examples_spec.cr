...
private def readme_configs(readme : String) : Array({Int32, String})
  ...
  mural = /^(style|output|outputs|users|groups|contributors|members|stargazers|sponsors|exclude|sort|limit|fail_on_missing|grid|honeycomb|mosaic|spiral|orbit|voronoi|stencil|theme|png):/m
